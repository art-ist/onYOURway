...
//Date.getDateOnly = function (date) {
//  return new Date(date.getFullYear(), date.getMonth(), date.getDate());
//}
//Date.getTimeOnly = function (date) {
//  return date.getTime() - date.getDateOnly().getTime() ;
//}

//Extension for moment to understand MS DateTime format
