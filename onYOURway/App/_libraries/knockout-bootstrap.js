///https://github.com/billpull/knockout-bootstrap/
...
function setupKoBootstrap(koObject) {
  ...
  koObject.bindingHandlers.typeahead = {
    init: function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
      ...
      var bindingValue = koObject.utils.unwrapObservable(valueAccessor());
        ...
        $element
          .attr("autocomplete", "off")
			    .typeahead({
			      ...
			      'valueKey': allBindings.valueKey,
			      'template': allBindings.template,
